...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:root://cmsxrootd.fnal.gov//store/mc/RunIII2024Summer24MiniAOD/DYto2Mu-4Jets_Bin-MLL-50_TuneCP5_13p6TeV_madgraphMLM-pythia8/MINIAODSIM/140X_mcRun3_2024_realistic_v26-v2/2560000/ad749229-3094-410f-94e3-2e408518e395.root')
)
...
process.Vertexer = cms.EDProducer("Vertexer",
    ...
    max_seed_vertex_chi2 = cms.double(-1),
    ...
    merge_shared_sig = cms.double(-1),
    min_track_vertex_sig_to_remove = cms.double(0),
    ...
    seed_tracks_src = cms.InputTag("displacedTracks"),
...
process.out = cms.OutputModule("PoolOutputModule",
    fileName = cms.untracked.string('/eos/user/a/amalhotr/DY2M_VertexerOutput.root')
)
...
process.GlobalTag = cms.ESSource("PoolDBESSource",
    ...
    globaltag = cms.string('133X_mcRun3_2024_realistic_v9'),
