...
process.moduloEventFilter = cms.EDFilter("ModuloEventFilter",
    modulo = cms.uint32(10),
    remainder = cms.untracked.uint32(9)
)
...
process.scoutingTree = cms.EDAnalyzer("ScoutingTreeMakerRun3",
    ...
    cut_ntk = cms.VPSet(
        ...
        cms.PSet(
            values = cms.vint32(2, 3)
        )
    ),
    cut_opening_angle_min = cms.vdouble(-1, 0.1, 0.25, 0.5),
    ...
    seed_use2DTrackDist = cms.untracked.bool(False),
...
process.p = cms.Path(process.moduloEventFilter+process.scoutingTrackCount+process.hltScoutingUnpackProducer+process.offlineBeamSpot+process.Vertexer+process.scoutingTree)
