...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('root://cmsxrootd.fnal.gov//store/mc/RunIII2024Summer24MiniAOD/DYto2Mu-4Jets_Bin-MLL-50_TuneCP5_13p6TeV_madgraphMLM-pythia8/MINIAODSIM/140X_mcRun3_2024_realistic_v26-v3/110000/0639b06f-0a53-4150-ac4f-ffab0df5ef91.root')
)
...
process.scoutingPlots = cms.EDAnalyzer("ScoutingPlotMakerRun3",
    ...
    cut_ntk = cms.VPSet(
        ...
        cms.PSet(
            values = cms.vint32(3, 4)
        )
    ),
    cut_opening_angle_min = cms.vdouble(
        -1, 0.05, 0.1, 0.25, 0.5,
        1.0
    ),
    ...
    seed_use2DTrackDist = cms.untracked.bool(True),
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('Scouting_MC_2024H_withHitCuts.root')
)
...
process.p = cms.Path(process.scoutingTrackCount+process.hltScoutingUnpackProducer+process.offlineBeamSpot+process.Vertexer+process.scoutingPlots)
