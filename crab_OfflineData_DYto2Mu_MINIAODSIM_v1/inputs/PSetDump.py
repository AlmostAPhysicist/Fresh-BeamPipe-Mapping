...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('root://cmsxrootd.fnal.gov//store/mc/RunIII2024Summer24MiniAOD/DYto2Mu-4Jets_Bin-MLL-50_TuneCP5_13p6TeV_madgraphMLM-pythia8/MINIAODSIM/140X_mcRun3_2024_realistic_v26-v3/110000/017d2bf5-4f3c-40ab-b6f9-c42381b6ae9b.root')
)
...
process.offlinePlots = cms.EDAnalyzer("ScoutingPlotMakerRun3",
    beamspot_src = cms.InputTag("offlineBeamSpot"),
    cut_ntk = cms.VPSet(
        cms.PSet(
            values = cms.vint32(3)
...
process.p = cms.Path(process.packedCandidateToTrack+process.offlineBeamSpot+process.Vertexer+process.offlinePlots)
