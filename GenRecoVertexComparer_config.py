...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string("GenRecoVertexComparer.root")
)
...
process.genRecoCompare = cms.EDAnalyzer("GenRecoVertexComparer",
    ...
    required_chi2 = cms.double(3.0),
    required_dBV_min = cms.double(0.01),
    required_dBV_max = cms.double(2.0),
    required_dxy_min = cms.double(-1.0),
    required_dxy_max = cms.double(-1.0),
    required_dBV_error = cms.double(0.005),
    required_dxy_error = cms.double(-1.0),
    min_nTracks = cms.int32(8),
    max_nTracks = cms.int32(-1),
    min_cosT = cms.double(0.0),
    ...
    use_pdgId = cms.bool(True),
    gen_pdgId = cms.untracked.int32(1000006),
    gen_status = cms.untracked.int32(106),
    useGenDaughters = cms.bool(True),
