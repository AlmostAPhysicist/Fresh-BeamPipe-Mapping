...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('root://cmsxrootd.fnal.gov//store/data/Run2024H/ScoutingPFRun3/HLTSCOUT/v1/000/385/933/00000/dc76810a-c42b-4f76-b965-7475a9b4fb96.root')
)
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('DY2M_ScoutingTree_Output_5_inputlocalrun.root')
)
