...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('root://cmsxrootd.fnal.gov//store/data/Run2024H/ScoutingPFRun3/HLTSCOUT/v1/000/385/836/00000/02fa9546-0c14-45e9-906a-ddd16bdd30ba.root')
)
...
process.scoutingTree = cms.EDAnalyzer("ScoutingTreeMakerRun3",
    ...
    max_chi2ndof = cms.double(10.0),
    max_dBV = cms.double(-1.0),
    max_dBV_error = cms.double(0.5),
    max_ntracks = cms.int32(4),
    min_dBV = cms.double(0.1),
    min_mass = cms.double(1.0),
    min_ntracks = cms.int32(3),
    primaryVertices = cms.InputTag("hltScoutingUnpackProducer","PrimaryVertex"),
    refPreference = cms.untracked.string('BS'),
    seed_maxIPSig = cms.untracked.double(100.0),
    seed_minIPSig = cms.untracked.double(4.0),
    seed_minPixelHits = cms.untracked.int32(1),
    seed_minPt = cms.untracked.double(0.9),
    seed_minStripHits = cms.untracked.int32(0),
    seed_minTrackerLayers = cms.untracked.int32(5),
    store_all_vertex_tracks = cms.bool(True),
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('ScoutingTree_Output.root')
)
...
process.p = cms.Path(process.scoutingTrackCount+process.hltScoutingUnpackProducer+process.offlineBeamSpot+process.Vertexer+process.scoutingTree)
