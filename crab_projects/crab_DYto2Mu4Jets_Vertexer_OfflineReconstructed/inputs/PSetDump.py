...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:///eos/user/a/amalhotr/BeamGeo/HLTUnpackerOutput.root')
)
...
process.out = cms.OutputModule("PoolOutputModule",
    fileName = cms.untracked.string('/eos/user/a/amalhotr/BeamGeo/VertexerOutput.root')
)
